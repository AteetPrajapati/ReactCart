      ...
      >
        ...
        <SwiperSlide>
          <ArgonBox
            sx={{
              position: "relative",
              backgroundImage: `url(${'https://picsum.photos/2000/3000?random=1'})`,
        ...
        <SwiperSlide>
          <ArgonBox
            sx={{
              position: "relative",
              backgroundImage: `url(${'https://picsum.photos/2000/3000?random=2'})`,
              backgroundSize: "cover",
              height: "100%",
            }}
          >
        ...
        <SwiperSlide>
          <ArgonBox
            sx={{
              position: "relative",
              backgroundImage: `url(${'https://picsum.photos/2000/3000?random=3'})`,
              backgroundSize: "cover",
              height: "100%",
            }}
          >
